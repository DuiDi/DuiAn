 ...
 */
public class Carte {
    String[] regions = {"Langue", "Histoire & Géographie", "Us & Coutumes","Culture pop moderne"};
    ...
    String[] regionOuest = {"Région du Nord", "Région du Sud", "Région de l'Ouest","Région de l'Est"};
    ...
    public String[] GetRegionSpec(String s){
        ...
        else if (s.compareTo("Histoire & Géographie") != 0){
            aRetourner = regionNord;
        }
        else if (s.compareTo("Us & Coutumes") != 0){
